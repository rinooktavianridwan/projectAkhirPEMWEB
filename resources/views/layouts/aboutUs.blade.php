        ...
        <div class="cards">
            <div class="card">
                ...
                <p>Our user-friendly platform lets you effortlessly list your car or find the perfect vehicle for your
                    trip. With a dedicated support team by your side, Ventur is your go-to for budget-friendly,
                    convenient car rentals. Join us today and experience travel the Ventur way.</p>
            </div>
            <div class="card">
                <h2>Our Priority</h2>
                <p><strong>Economical & Easy Car Rental:</strong> Ventur makes car rentals easy and budget-friendly. We
                    ...
                    transportation.</p>
                <p><strong>User-Friendly Platform:</strong> Ventur streamlines the rental process with a user-friendly
